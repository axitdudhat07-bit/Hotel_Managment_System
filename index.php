...
<body class="bg-light">
    ...
    <div class="container">
        <div class="row justify-content-evenly px-lg-0 px-md-0 px-5 ">
            ...
            ?>
            <dvi class="col-lg-12 text-center mt-5">
    ...
    <div class="container mt-5">
        <div class="swiper swiper-testimonials">
            <div class="swiper-wrapper mb-5">
                ...
                $review_q = "SELECT rr.*,uc.name AS uname,uc.profile,r.name AS rname FROM `rating_review` rr INNER JOIN `user_cred` uc ON rr.user_id=uc.id
        ...
        <div class="col-lg-12 text-center mt-5">
            <a href="about.php" class="btn btn-sm btn-outline-dark rounded-0 fw-bold shadow-none">Konw More >>></a>
        </div>
    </div>
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-4">
                <div class="bg-white p-4 rounded mb-4 ">
                    <h5>Call us</h5>
                    <a href="tel: +<?php echo $contact_r['pn1'] ?>" class="d-lg-inline-block mb-2 text-decoration-none text-dark"><i
                            class="bi bi-telephone-fill"></i> +<?php echo $contact_r['pn1'] ?></a>
                    <br>
                    <?php
                    if ($contact_r['pn2'] != '') {
                        echo <<<data
                                <a href="tel: +$contact_r[pn2]" class="d-lg-inline-block text-decoration-none text-dark">
                ...
                <form id="recovery-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-shield-lock fs-3 me-3 "></i> Set up New Password
                        </h5>
                    </div>
                    <div class="modal-body">
                        ...
                        <div class="md-2 text-end">
                            <button type="button" class="btn shadow-none m-2" data-bs-dismiss="modal">
                                CANCEL
                            </button>
