    ...
    <div class="container">
        <div class="row">
            ...
            $query = "SELECT bo.*,bd.* FROM `booking_order` bo INNER JOIN `booking_details` bd ON bo.booking_id=bd.booking_id
                ...
                OR (bo.booking_status='payment failed')) AND (bo.user_id=?)
                ...
                <form id="review-form">
                    <div class="modal-header">
                        <h5 class="modal-title d-flex align-items-center">
                            <i class="bi bi-chat-square-heart-fill fs-3 me-3 "></i> Rate & Review
                        </h5>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="mb-4">
                            ...
                            <textarea name="review" required row="3" class="form-control shadow-none"></textarea>
                        </div>
