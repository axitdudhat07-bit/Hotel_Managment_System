...
<body class="bg-light">
            ...
            <div class="col-lg-3 col-md-12 mb-4 mb-lg-0 ps-4">
                <nav class="navbar navbar-expand-lg navbar-light bg-white rounded shadow">
                    <div class="container-fluid flex-lg-column align-items-stretch">
                        <h4 class="mt-2 mb-3 d-flex align-items-center justify-content-between">
                            <span>FILTERS</span>
                            <button id="resetAll_btn" onclick="resetAll_clear()" class="btn shadow-none btn-sm text-secondary d-none">Reset</button>
                        </h4>
                        ...
                        <div class="collapse navbar-collapse flex-column mt-2 align-items-stretch" id="filterDropdown">
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <input type="date" class="form-control shadow-none" id="checkout" onchange="chk_avail_filter()" value="<?php echo $checkout_default ?>">
                            </div>
                            <div class="border bg-light p-3 rounded mb-3">
                                <h5 class="mb-3 d-flex align-items-center justify-content-between" style="font-size: 18px;">
                                ...
                                while ($row = mysqli_fetch_assoc($facilities_q)) {
                                    echo <<<facilities
                                        <div class="mb-2">
                                                ...
                                                <label class="form-chech-label" for="$row[id]">$row[name]</label>
                                        </div>
                                        facilities;
                                }
                                ?>
                            ...
                            <div class="border bg-light p-3 rounded mb-3">
                                ...
                                <div class="d-flex">
                                    ...
                                    <div>
                                        ...
                                        <input type="number" min="1" id="children" value="<?php echo $children_default ?>" oninput="guests_filter()" class="form-control shadow-none mb-3">
                                    </div>
                                </div>
                            </div>
                        </div>
    ...
    <script>
        ...
        let resetAll_btn = document.getElementById('resetAll_btn');

        let today = new Date().toISOString().split('T')[0];

        // डेट इनपुट में आज की तारीख सेट करें और अधिकतम सीमा निर्धारित करें
        ...
        function fetch_rooms() {
            ...
            if (get_facilities.length > 0) {
                ...
                resetAll_btn.classList.remove('d-none');
            } else {
                facilities_btn.classList.add('d-none');
                resetAll_btn.classList.add('d-none');
