...
if (isset($_POST['check_availability'])) {
    ...
    //check booking availabilty if status is blank else return the error
    ...
    if($status!=''){
        ...
        AND check_out>? AND check_in>$frm_data[check_out]";

        $values=['booked',$_SESSION['room']['id'],$frm_data['check_in']];
