                ...
                <div class="card border-0 shadow-sm mb-4">
                    <div class="card-body">
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                <div class="mb-4">
                                    <h6 class="card-subtitle mb-1 fw-bold">Socical Links</h6>
                                    <p class="card-text mb-1">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-6">
                                                <div class="mb-3">
                                                    ...
                                                    <div class="input-group mb-3">
                                                        <span class="input-group-text"> <i class="bi bi-twitter-x "></i>
                                                        </span>
                                                        <input type="text" name="tx" id="tw_inp" class="form-control shadow-none">
                                                    </div>
                                                </div>
                                                <div class="mb-3">
                    ...
                    <div class="modal-dialog">
                        <form id="team_s_form">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-footer">
                                    <button type="button" class="btn text-secondary shadow-none" onclick="member_name_inp.value='', member_picture_inp.value='' " data-bs-dismiss="modal">CANCEL</button>
                                    <button type="submit" class="btn custom-bg text-white shadow-none ">SUBMIT</button>
                                </div>
                            </div>
                        </form>
